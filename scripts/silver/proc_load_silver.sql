...
BEGIN
    ...
    BEGIN TRY
       ...
       -- data clean and insert table crm_cust_info
        ...
        *,
        ...
        PRINT '<< LOAD DURATION :' + CAST(DATEDIFF(second,@start_time,@end_time)AS NVARCHAR) + 'secodns';
        PRINT '----------------------------------------------';
        ...
        -- data cleaning and inserting erp_px_cat_g1v2
        SET @start_time = GETDATE();
